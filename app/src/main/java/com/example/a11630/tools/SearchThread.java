...
public class SearchThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            sendDate = "name:服务器:msg:上课成功:type:search".getBytes();//设置发送数据
            ...
            while (flag) {
                ...
                if (recvContent.contains("stop_search")) {
                    ...
                    //学生信息
                    //////////
//                    Intent now_teacher=getIntent();
//                    msg=now_teacher.getStringExtra("data")+"|"+msg;
//                    sendMsg("收到：" + recvDP.getAddress() + ":" + recvDP.getPort() +
//                            " \n发来：" + now_teacher.getStringExtra("data")+"|"+recvContent);
                    ...
                    sendDate = "name:服务器:msg:上课成功:type:response".getBytes();//回应内容
